...
report() {
	...
	echo '</div><div id="footer"><h3>xnetnum</h3><p>Penetration Test Wrapper</p><span>Version: 1.2</span> <span>Author: W315 (2019)</span></div></div><div id="right-panel"> <div id="info" name="info" class="show"><div class="right-content"><h1>Test Information</h1><hr><table class="tile"><tr><td><p><b>Test Name:</b></p></td>' >> ./$pentest/$pentest-Report.html
...
banner() { 
	...
	echo -e $green
	echo -e " __    __             __  "                    
	echo -e " \ \  / / ____  ___  / /_____  __  __________ "
...
usage() {
	...
	echo
	echo " usage: ./xnetnum.sh -d"
	echo " usage: ./xnetnum.sh -n <new test name>"
	echo
